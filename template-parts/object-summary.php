	...
	<div class="container">
		...
		<?php if ( 'hikes' == get_post_type() ) { ?>
			...
			<div class="object-summary--rt">
				<iframe width="100%" height="350" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=<?php echo fo_get_hike_gps_location();?>&key=AIzaSyAmZRRKW006CPNupNCPJx1jfVfdHiP3QvI" allowfullscreen></iframe>
			</div>
		<?php } else { ?>
			<h3>TLDR;</h3>
